/*
Problem: Write a program to Rotate array left.
...
4. The function will reverse the array from 0 to k-1,
  then reverse k to n-1, and finally it will reverse 0 to n-1.
